...
const Home = () => {
  return (
    <div className='h-screen flex items-center'>
        <form className="max-w-md mx-auto shadow p-10 border rounded-md">
            ...
            <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900">Jónelisti tańlań</label>
                <select id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    <option disabled selected>Jónelisti tańlań</option>
                    <option>Стоматология иши</option>
                    <option>Ҳамширалик иши</option>
                    <option>Марказлаштирилган пост оператори</option>
                </select>
            </div>
            <div className="relative z-0 w-full mb-5">
                <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900">Tálim túrin tańlań</label>
                <select id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    <option disabled selected>Tálim túrin tańlań</option>
                    <option>Kúndizgi</option>
                    <option>Sırtqı</option>
                </select>
            </div>
            <div className='flex justify-end'>
                <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Jiberiw</button>
            </div>
        </form>
    </div>
  )
